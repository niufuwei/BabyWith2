...
//        self.wantsFullScreenLayout = YES;
        ...
        {
            _shrinkImage.frame=CGRectMake(25, (overlyView.frame.size.height - 25)/2+5, 50, 30);
        ...
        {
            cameraBtn = [UIButton buttonWithType:UIButtonTypeCustom];
            cameraBtn.frame=CGRectMake(125, overlyView.frame.size.height-45, 70, 40);
            
            imageButton = [UIButton buttonWithType:UIButtonTypeCustom];
            imageButton.frame=CGRectMake(25, (overlyView.frame.size.height - 25)/2-10, 40, 50);
