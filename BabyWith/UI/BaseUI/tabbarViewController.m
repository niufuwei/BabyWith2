...
//    itemBG = [[UIImageView alloc]initWithImage:[UIImage imageNamed:@"tabbar_item_selected.png"]];
    ...
    homeBtn.tag = 0;
    homeBtn.frame = CGRectMake(0.0, 0.0, 80, 49.0);
    [homeBtn setImage:[UIImage imageNamed:@"主菜单栏-选中 (1).png"] forState:UIControlStateNormal];
...
//    [homeBtn setBackgroundColor:[UIColor colorWithRed:37.0/255 green:73.0/255 blue:157.0/255 alpha:1.0]];
    ...
    myTaobaoBtn.tag = 1;
    myTaobaoBtn.frame = CGRectMake(80, 0.0, 80, 49.0);
    [myTaobaoBtn setImage:[UIImage imageNamed:@"主菜单栏-未选 (2).png"] forState:UIControlStateNormal];
...
//    [myTaobaoBtn setBackgroundColor:[UIColor colorWithRed:52.0/255 green:169.0/255 blue:220.0/255 alpha:1.0]];
    ...
    _cartBtn.tag = 2;
    _cartBtn.frame = CGRectMake(80*2, 0.0, 80, 49.0);
    [_cartBtn setImage:[UIImage imageNamed:@"主菜单栏-未选 (3).png"] forState:UIControlStateNormal];
...
//    [_cartBtn setBackgroundColor:[UIColor colorWithRed:52.0/255 green:169.0/255 blue:220.0/255 alpha:1.0]];
    ...
    weitaoBtn.tag = 3;
    weitaoBtn.frame = CGRectMake(80*3, 0.0, 80, 49.0);
    [weitaoBtn setImage:[UIImage imageNamed:@"主菜单栏-未选 (4).png"] forState:UIControlStateNormal];
    //[_cartBtn set Title:@"我的" forState:UIControlStateNormal];
    //[_cartBtn setTitleColor:[UIColor whiteColor]forState:UIControlStateNormal];
    //[cartBtn setTitleColor:[UIColor colorWithRed:235.0/255.0 green:81.0/255.0 blue:17.0/255.0 alpha:1] forState:UIControlStateSelected];
    //_cartBtn.titleLabel.font = [UIFont systemFontOfSize:15.0];
    ...
    weitaoBtn.adjustsImageWhenHighlighted = FALSE;
    
    [_tabbarBG addSubview:weitaoBtn];
}
...
- (void)myTaobaoBtn_Click:(UIButton *)button
{
    ...
    else
    {
        ...
        [homeBtn setImage:[UIImage imageNamed:@"主菜单栏-未选 (1).png"] forState:UIControlStateNormal];
        [myTaobaoBtn setImage:[UIImage imageNamed:@"主菜单栏-选中 (2).png"] forState:UIControlStateNormal];
        [_cartBtn setImage:[UIImage imageNamed:@"主菜单栏-未选 (3).png"] forState:UIControlStateNormal];
        [weitaoBtn setImage:[UIImage imageNamed:@"主菜单栏-未选 (4).png"] forState:UIControlStateNormal];
...
- (void)cartBtn_Click:(UIButton *)button
{
    ...
    else
    {
        ...
        [homeBtn setImage:[UIImage imageNamed:@"主菜单栏-未选 (1).png"] forState:UIControlStateNormal];
        [myTaobaoBtn setImage:[UIImage imageNamed:@"主菜单栏-未选 (2).png"] forState:UIControlStateNormal];
        [_cartBtn setImage:[UIImage imageNamed:@"主菜单栏-选中 (3).png"] forState:UIControlStateNormal];
        [weitaoBtn setImage:[UIImage imageNamed:@"主菜单栏-未选 (4).png"] forState:UIControlStateNormal];
...
- (void)weitaoBtn_Click:(UIButton *)button
{
    if(currentPage ==3)
    {
    ...
    else
    {
        ...
        myTaobaoBtn.selected = NO;
        _cartBtn.selected = NO;
        weitaoBtn.selected = YES;
        
        itemBG.frame = CGRectMake(80*3, 0, 80, 49);
        self.selectedIndex = button.tag;
        
        [homeBtn setImage:[UIImage imageNamed:@"主菜单栏-未选 (1).png"] forState:UIControlStateNormal];
        [myTaobaoBtn setImage:[UIImage imageNamed:@"主菜单栏-未选 (2).png"] forState:UIControlStateNormal];
        [_cartBtn setImage:[UIImage imageNamed:@"主菜单栏-未选 (3).png"] forState:UIControlStateNormal];
        [weitaoBtn setImage:[UIImage imageNamed:@"主菜单栏-选中 (4).png"] forState:UIControlStateNormal];
